		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices list",
									"targetURL": "#logaligroupinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupinvoices-display": {
								"semanticObject": "logaligroupinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.invoices",
									"url": sap.ui.require.toUrl("logaligroup/invoices")
								}
							}
						}
					}
